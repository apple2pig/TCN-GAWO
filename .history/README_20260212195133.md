...
This project implements a **Temporal Convolutional Network (TCN)** combined with a **Genetic Algorithm with Weighted Average Optimization (GAWO)** for Remaining Useful Life (RUL) prediction on aircraft turbofan engines.
...
## TCN-GAWO Architecture Overview
...
```bash
git clone https://github.com/yourusername/TCN-GAWO.git
cd TCN-GAWO
```
...
### 3. Genetic Algorithm Optimization (GAWO)
...
- Open an issue on [GitHub Issues](https://github.com/yourusername/TCN-GAWO/issues)
...
[⬆ Back to Top](#tcn-GAWO-temporal-convolutional-network-with-genetic-algorithm-for-rul-prediction)
